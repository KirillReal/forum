...
public class AnswerController {
    ...
    public AnswerController(AnswerService answers, CommentService comments, PostService posts,
                            UserService users) {
    ...
    public String save(@RequestParam("id") int id, @ModelAttribute Answer answer) {
        ...
        answer.setAuthor(users.findByUsername(SecurityContextHolder.getContext()
    ...
    public String delete(@RequestParam("id") int id) {
        ...
        Optional<Comment> comment = comments.findCommentsByAnswer(answer.get());
        comment.get().deleteAnswer(answer.get());
        answers.delete(answer.get());
        return "redirect:/post?id=" + posts.findPostByCommentId(comment.get()
                .getId()).get().getId();
    }
